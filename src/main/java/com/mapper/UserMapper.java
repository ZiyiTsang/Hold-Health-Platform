...
public interface UserMapper {
    ...
    int addUser(@Param("username") String username, @Param("password") String password, @Param("profile") String profile, @Param("email") String email,@Param("gender")boolean gender);
